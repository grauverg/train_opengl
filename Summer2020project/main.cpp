...
double ground[GSZ][GSZ] = { 0 }; // матрица высоты плато
double treesHeights[NUM_Trees] = { 0 }; // матрица высоты дерева
double treesBases[NUM_Trees] = { 0 }; // матрица длины стволов деревьев
int treesiTree[NUM_Trees] = { 0 }; // матрица первого индекса деревьев 
int treesjTree[NUM_Trees] = { 0 }; // матрица второго индекса деревьев 

// texture definitions
unsigned char tx0[TH][TW][3]; // 3 rgb
unsigned char tx1[1024][1024][3]; // вода
unsigned char tx2[1024][2048][3]; // рассвт
unsigned char tx3[1024][1024][3]; // трава
unsigned char tx4[512][512][3]; // деревья
unsigned char tx5[512][512][3]; // листва
unsigned char tx6[1024][1024][3]; // снег 
